...
class PHPdate {
	...
	private $TZN = array(
		...
		"asia/riyadh"			=> 3,
		"europe/moscow"			=> 3,
		"asia/tehran"			=> 3.5,		// (+3:30 hours)
		"asia/baku"				=> 4,
		"europe/volgograd"		=> 4,
		"asia/muscat"			=> 4,
		"asia/tbilisi"			=> 4,
		"asia/yerevan"			=> 4,
		"asia/kabul"			=> 4.5,		// (+4:30 hours)
		"asia/karachi"			=> 5,
		"asia/tashkent"			=> 5,
		"asia/kolkata"			=> 5.5,		// (+5:30 hours)
		"asia/kathmandu"		=> 5.75,	// (+5:45 hours)
		...
		"asia/seoul"			=> 9,
		"asia/tokyo"			=> 9,
		"australia/adelaide"	=> 9.5,		// (+9:30 hours)
		"australia/darwin"		=> 9.5,		// (+9:30 hours)
		"asia/yakutsk"			=> 10,
